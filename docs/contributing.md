...
```sh
git clone https://github.com/[YOUR GITHUB ACCOUNT]/pycon_archive_past_website.git
```

### Step 3. Add this repository to the remote in your local repository

```sh
git remote add upstream "https://github.com/pycontw/pycon_archive_past_website"
```
